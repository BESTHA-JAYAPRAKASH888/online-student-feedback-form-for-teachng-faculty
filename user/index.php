      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=update_profile"><span style="color: #ff751a"  class="glyphicon glyphicon-asterisk"></span><span style="color: #ff751a"> Update Profile</span></a></li>
			 <li><a href="index.php?page=feedback"><span style="color: #ff751a" class="glyphicon glyphicon-thumbs-down"></span><span style="color: #ff751a"> Feedback</span></a></li>
		...
		@$page=  $_GET['page'];
		  ...
		  <h1 class="page-header" style="color: #ff6600">Dashboard</h1>

...
<form method="post">
	...
	<div class="row" style="margin-top:10px">
		...
		<input style="background-color:#E2502C;color:#FFFFFF" type="submit" value="Update Password" name="save" class="btn btn-success"/>
		<input style="background-color:#E2502C;color:#FFFFFF" type="reset" class="btn btn-success"/>
		</div>
	</div>
</form>	
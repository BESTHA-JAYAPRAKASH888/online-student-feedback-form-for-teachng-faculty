...
?>
	...
	<caption><h2 align="center" style="color:#E2502C">Registration Form</h2></caption>
	<Tr>
...
<input style="background-color:#E2502C;color:#FFFFFF" type="submit" value="Save" class="btn btn-info" name="save"/>
<input style="background-color:#E2502C;color:#FFFFFF" type="reset" value="Reset" class="btn btn-info"/>

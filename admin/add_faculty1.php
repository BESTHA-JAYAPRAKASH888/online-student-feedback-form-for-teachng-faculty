...
<input style="background-color:#E2502C;color:#FFFFFF" type="submit" value="Save"  name="save"/>
<input style="background-color:#E2502C;color:#FFFFFF" type="reset" value="Reset" "/>

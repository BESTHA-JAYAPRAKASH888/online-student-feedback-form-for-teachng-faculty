...
<head>
	...
	<title>Online Student Feedback Form For Teaching Faculty</title>
...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#E2502C">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">Online Student Feedback Form For Teaching Faculty</a>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/rgm.jpg');"></div>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2 style="color:#E2502C">About Faculty feedback System</h2>
				Student Feedback form for teaching faculty in College  
Here we will develop the a faculty based feedback system, which is generally used in the college to rate and analysis of the faculty's performance...Here we have 3 modules such as administrator, student and faculty.
...
student before enter into the potral than he can register with their credentials.
If you entered the student user and password and selected student option, then it will show all student information and let you enter the feedback based on the subject..
    ...
    <div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#E2502C">
